...
//            return DPFPGlobal.getSampleConversionFactory().createImage(sample);
    ...
    public void guardarHuella(){
        ...
        try {
                ...
                if (button != "") {  
                    int r = huellaDAO.guardarHuella(Integer.parseInt(txt_id_user.getText()),button, template,featuredVerificacion);   
                    
                    if(r == 1)
                        JOptionPane.showMessageDialog(this, "Se Guardo la huella Correctamente.");
                    else
                        JOptionPane.showMessageDialog(this, "Error al Guardar la Huella.");
    ...
    public void VerificarHuella(String dedo){
        ...
        try {
             ...
             if (dedo != "") {  
                Usuario user = new Usuario();
                 user = huellaDAO.VerificarHuella(Integer.parseInt(txt_id_user.getText()), dedo,Verificador, featuredVerificacion);
